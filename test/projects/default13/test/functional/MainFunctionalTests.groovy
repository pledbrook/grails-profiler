class MainFunctionalTests extends functionaltestplugin.FunctionalTestCase {
    void testSomeWebsiteFeature() {
        ...
        assertStatus 200
        checkTimeOutput()
        assertContentContains "Entering [uri: /default13/time] TimeController:index"
        assertContentContains "Exiting [uri: /default13/time] TimeController:index"
        assertContentContains "Entering [uri: /default13/time] DateService:currentTime"
        assertContentContains "Exiting [uri: /default13/time] DateService:currentTime"
    }
